...
Project.find_or_create_by!(title: "Project with conversation").tap do |project|
  ...
  project.save!
  project.entries.create!(entryable: Event.create!(occasion: "project_closed"), creator: User.first)
